...
export const description = "Track any layer as a named screen, popup, or tooltip — then open, close, and navigate between them with simple actions. Focus stacks handle back-navigation automatically, animations play on every transition, and interactivity is always kept consistent.";
